  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final scale = widget.animation.value * (1.0 + (_hoverAnimation.value * 0.02));
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        ...
        onTap: onPressed,
        onHover: onHover,
        splashColor: (isDarkMode ? AppColors.brandAccent : AppColors.brandPrimary)
            .withValues(alpha: 0.2),
        highlightColor: (isDarkMode ? AppColors.brandAccent : AppColors.brandPrimary)
            .withValues(alpha: 0.1),
        child: Container(
                ...
                Positioned.fill(
                  child: Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: (isDarkMode ? AppColors.brandAccent : AppColors.brandPrimary)
                            .withValues(alpha: 0.3),
                        width: 2,
                      ),
                    ),
